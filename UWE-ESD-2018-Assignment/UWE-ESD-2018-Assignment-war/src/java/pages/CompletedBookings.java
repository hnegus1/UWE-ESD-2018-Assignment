 ...
 * @author Isaac
 */
public class CompletedBookings extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("table", addList("SELECT ID, ORIGIN, DESTINATION, PRICE, DEPARTURETIME, DEPARTUREDATE FROM JOURNEY WHERE COMPLETED=1 AND PAID=1 AND CUSTOMERID=" + customerID, "RADIO"));
        //session.setAttribute("table", addList("SELECT * FROM JOURNEY WHERE COMPLETED=0 AND CUSTOMERID=" + customerID, "RADIO"));
        response.sendRedirect("ViewCompletedJourneys.jsp");
    }
